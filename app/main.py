...
from app.routers import auth, users, categories, products, cart, orders, reviews, payments, admin, inventory, tasks, manager, product_content, analytics, marketing, quotations
